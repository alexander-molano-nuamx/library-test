...
const { MoreHoriz, ArrowForward, DragIndicator } = MaterialIcons;
...
function Dashboard() {
  ...
  return (
    <Box sx={{ minHeight: '100vh' }}>
      ...
      <Content openDrawer={sidebarOpen} sx={{ minHeight: 'calc(100vh - 49px)' }}>
        <Box sx={{ display: 'flex', gap: 3, p: 3, minHeight: 'inherit' }}>
          <Box sx={{ flex: 1 }}>
            <Paper sx={{ mb: 3 }}>
